window.onload = function () {
        ...
        if (query_val == "") {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    ...
                    var mainBomHtml = '<ul id="mainbom"><li>第<span id="maincurr">' +
                        resp.data.current_page + '</span>页</li><li>共<span id="maintota">' +
                        resp.data.total_page + '</span>页</li><li><a class="mainpage">'
                        + '首页</a></li><li><a class="mainpage">上一页</a></li>';
                    for (i = 1; i <= resp.data.total_page; i++) {
                        mainBomHtml += '<li><a class="mainpage">' + i + '</a></li>';
                    }
                    mainBomHtml += '<li><a class="mainpage">下一页</a></li><li><a class="mainpage">末页</a></li></ul>';
    ...
    $("#mainbom").on('click', '.mainpage', function () {
        ...
        if (query_val == "") {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    ...
                    var sonBomHtml = '<ul id="sonbom"><li>第<span id="soncurr">' +
                        resp.data.current_page + '</span>页</li><li>共<span id="sontota">' +
                        resp.data.total_page + '</span>页</li><li><a class="sonpage">'
                        + '首页</a></li><li><a class="sonpage">上一页</a></li>';
                    for (i = 1; i <= resp.data.total_page; i++) {
                        sonBomHtml += '<li><a class="sonpage">' + i + '</a></li>'
                    }
                    sonBomHtml += '<li><a class="sonpage">下一页</a></li><td><a class="sonpage">末页</a></td> </ul>';
    ...
    $("#sonbom").on('click', '.sonpage', function () {
